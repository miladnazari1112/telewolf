...
local function run(msg, matches)
  if matches[1]:lower() == 'telewolf' then -- Put everything you like :)
    local about = _config.about_text
    local name = user_print_name(msg.from)
    savelog(msg.to.id, name.." ["..msg.from.id.."] used /telewolf ")
    return about
  end 
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "telewolf" then -- Put everything you like :)
